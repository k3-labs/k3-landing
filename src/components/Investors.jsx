...
const Investors = () => {
  return (
    <div className="bg-[#FBFBFB]  pb-12 md:pb-14 lg:pb-[120px]  ">
      <div className="py-12 px-6 md:px-16 lg:px-5 text-center ">
        <h2
      ...
      <div className="w-full">
        <div className="flex pb-12 justify-center items-center w-full  gap-12 flex-wrap  ">
          <Image
            quality={100}
            unoptimized
            src={bff}
        ...
        <div className="flex  justify-center items-center w-full  gap-12 flex-wrap  ">
          ...
          <div className="flex gap-2 items-center">
            <Image
              ...
              height={28} // 35 * 0.8 = 28
            />
            <h5 className="text-blackLight text-[22px] font-medium leading-5 -tracking-[0.07px]">
              Othenthic
            </h5>
          </div>
        </div>
