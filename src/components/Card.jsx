...
const Card = (props) => {
  ...
  return (
    <div
      className="flex flex-col  w-[146px] sm:w-[170px] md:w-full justify-center items-start py-3 px-4 md:p-6 gap-2 md:gap-4 max-w-72  h-[76px] md:h-[120px] rounded-2xl "
      style={{
